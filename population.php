...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <?php
      ...
      $state=$_GET['state'];
      $city=$_GET['city'];
      $query="SELECT * FROM Population WHERE statename='$state' AND cityname='$city'";
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          <ol class="breadcrumb">
            <li class="breadcrumb-item active">Population: <?php print $city.", ".$state; ?></li>
          </ol>
        </div>
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Population Information</div>
          <div class="card-body">
            <canvas id="populationChart" width="100%" height="30"></canvas>
